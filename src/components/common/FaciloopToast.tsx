    ...
    <AnimatePresence>
      {message && (
        <motion.div
          ...
          className={`fixed bottom-4 left-4 right-4 sm:left-1/2 sm:-translate-x-1/2 sm:max-w-md z-50 shadow-2xl p-3.5 px-4 rounded-2xl flex items-center justify-between text-white font-bold text-xs sm:text-sm select-none ${
            type === 'success'
